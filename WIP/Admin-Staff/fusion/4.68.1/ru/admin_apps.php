...
$__LANG = array(
	...
	'appdetails'             => 'Сведенья модуля',
	'versioninfo'            => 'Информация о текущей версии',
	'appinstalled'           => 'УСТАНОВЛЕНО',
	'appstatus'              => 'Статус',
	'appnotinstalled'        => 'НЕ УСТАНОВЛЕНО',
	'appupgraderequired'     => 'НЕОБХОДИМО ОБНОВЛЕНИЕ',
	'appdbversion'           => 'Установленная версия',
	'applatestversion'       => 'Последняя версия',
	'appauthor'              => '<b>Автор:</b> %s',
	'viewapp'                => 'Просмотреть модуль',
	'tabgeneral'             => 'Общие',
	'appinstall'             => 'Установить',
	'appuninstall'           => 'Удалить',
	'apprtitle'              => 'Название модуля',
