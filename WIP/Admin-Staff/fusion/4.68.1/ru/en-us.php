...
$__LANG = array(
	...
	'app_troubleshooter'           => 'Пошаговые руководства',
	'app_news'                     => 'Новости',
	'app_core'                     => 'Ядро',
	'app_backend'                  => 'Бэкенд',
	'app_reports'                  => 'Отчеты',
	...
	'advanced_search'              => 'Настраиваемый поиск',
...
if ($_SWIFT->Interface->GetInterface() == SWIFT_Interface::INTERFACE_ADMIN)
{
	...
	*/
	...
	$_adminBarContainer = array (
		...
		29 => array('Автодействия', 'bar_workflow.gif', APP_TICKETS, '/Tickets/Workflow/Manage'),
		...
		20 => array('Прогноз по Байесу', 'bar_bayesian.gif', APP_TICKETS),
		21 => array('База знаний', 'bar_knowledgebase.gif', APP_KNOWLEDGEBASE),
		23 => array('Новости', 'bar_news.gif', APP_NEWS),
		24 => array('Пошаговые руководства', 'bar_troubleshooter.gif', APP_TROUBLESHOOTER),
	...
	$_adminBarItemContainer = array(
		0  => array(
			...
			6 => array('Логотипы в заголоке', '/Base/TemplateManager/Personalize'),
		),
		...
		4  => array(
			...
			3 => array('Линии разрыва', '/Parser/Breakline/Manage'),
			4 => array('Баны', '/Parser/Ban/Manage'),
			5 => array('Общие правила', '/Parser/CatchAll/Manage'),
			6 => array('Журнал фильтра циклов', '/Parser/LoopBlock/Manage'),
			7 => array('Правила фильтра циклов', '/Parser/LoopRule/Manage'),
		...
		10 => array(
			0 => array('Настроить', '/Base/ScheduledTasks/Manage'),
			1 => array('Журнал заданий', '/Base/ScheduledTasks/TaskLog'),
		),
		...
		26 => array(
			...
			1 => array('Информация о API', '/Base/RESTAPI/Index'),
		),
	...
	*/
	$_adminLinkContainer = array (
		...
		3 => array(
			0 => array('Управление департаментами', '/Base/Department/Manage'),
	...
	*/
	...
	$_staffMenuContainer = array(
		...
		6 => array('Пошаговые руководства', 140, APP_TROUBLESHOOTER, 'tr_entab'),
	...
	*/
	$_staffLinkContainer = array (
		...
		1 => array(
			0 => array('Главная', '/Base/Home/Index'),
			1 => array('Мои настройки', '/Base/Preferences/ViewPreferences'),
		...
		5 => array(
			0 => array('Показать загрузки', '/Downloads/Downloads/Manage'),
			1 => array('Управление загрузками', '/Downloads/Downloads/Manage'),
			2 => array('Категории', '/Downloads/Category/Insert'),
			3 => array('Создать файл', '/Downloads/File/Insert'),
		),

		6 => array(
			0 => array('Пошаговые руководства', '/Troubleshooter/Category/ViewAll'),
			1 => array('Список шагов', '/Troubleshooter/Step/Manage'),
			2 => array('Список руководств', '/Troubleshooter/Category/Manage'),
