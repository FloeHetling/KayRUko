...
$__LANG = array (
	...
	'desc_staffmobilenumber' => 'If you wish to receive SMS notifications, enter your mobile telephone number.<br/><i>Note: Enter only your telephone number without spaces, dashes or other symbols.<br/>Example: \'18005551212\'</i> ',
	...
	'enablepmalerts' => 'Enable Private Message Email Notifications',
	'enablepmjsalerts' => 'Enable Private Message JavaScript Notifications',
	'desc_enablepmalerts' => 'Select whether or not you wish to receive an email notification when a private message is sent to you.',
	...
	'desc_staffemail' => 'Enter your personal email address here. Any helpdesk notifications will be sent to this address.'.IIF(SWIFT_App::IsInstalled(APP_PARSER), ' Make sure that this address has not been associated with an email queue.  If there is an already existing email queue with the same address, it may create bounce-back loops, causing performance problems.'),
