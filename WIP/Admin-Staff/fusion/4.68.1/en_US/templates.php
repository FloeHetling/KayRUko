...
$__LANG = array (
	...
	'desc_templateeditingguideline' => 'Using the template editor you can customize the look and feel of the support center. If a future Kayako update also includes changes to the same template, you will be asked to restore the template to the latest original version. This will undo your template changes and you will need to reapply them.<br><br>To minimize potential headaches, check out the <a href="http://www.dereferer.com/?http://wiki.kayako.com/display/DOCS/Template+editing+best+practice+guide" target="_blank">template editing best practices guide</a> before customizing your support center.',
