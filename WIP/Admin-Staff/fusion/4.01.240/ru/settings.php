...
$__LANG = array (
	...
	'd_t_autorespondercc' => 'If Enabled, ' . SWIFT_PRODUCT . ' will automatically dispatch an autoresponder message to the CC users.',
	...
	// ======= TICKETS =======
	't_cleanmailsubjects' => 'Enable Clean Email Subjects?',
	'd_t_cleanmailsubjects' => 'If enabled, ticket IDs will be suffixed (using a + sign) to the <b>from</b> email address alias (sales+ABC-123-4567@acme.com) rather than being included in the email subject.<br /><br /><b>EXPERIMENTAL FEATURE:</b> This feature is experimental and we do not recommend enabling it for production use without thorough testing. Although email aliases with a + symbol is valid, it may upset some mail transport agents.',
	...
	'd_t_autorecip' => 'Automatically add CC\'ed email addresses in the incoming email as the ticket recipients.',
	...
	't_cstaffname' => 'Enable Staff Name Override',
	'd_t_cstaffname' => 'Allows you to override the staff name visible to users in the support center and replace it with a common keyword like "Kayako Support"',
	't_cdisplayname' => 'Overriden Staff Name',
	'd_t_cdisplayname' => 'You can specify the keyword that should be displayed if the above setting is disabled.',
